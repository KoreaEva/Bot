...
namespace YoungWook.LUIS.PTT
{
    public partial class frmMain : Form
    {
        ...
        {
            string ConnectionString = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\yowkim\Documents\LUIS_Data.xlsx;Extended Properties='Excel 8.0;HDR=No'";
        ...
        private void btnSaveJSON_Click(object sender, EventArgs e)
        {
            ...
            System.IO.File.WriteAllText(@"C:\Users\yowkim\Documents\LUIS.json", resultJson, Encoding.UTF8);
        }
    }
}
